    ...
    <footer className="bg-gray-900 text-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="text-sm font-medium uppercase tracking-wider text-gray-400 mb-4">Quick Links</h4>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6 text-xs text-gray-500">
              ...
              <li><a href="#" className="hover:text-gray-400 transition-colors">Disclaimer</a></li>
            </ul>
          </div>
        </div>
      </div>
